...
Experiment* Experiment::get_experiment(){
	...
	switch(exp_id){
		...
		case WAMCARTESIANPOS:{  return new BHTorque(robot);}
		case WAMJOINTTORQUE:{   return new BHTorque(robot);}
		case BHVELOCITY:{       return new BHTorque(robot);}
		case BHPOSITION:{       return new BHTorque(robot);}
		case BHTORQUE:{         return new BHTorque(robot);}
		...
		//case TEACHANDPLAY:{  return new TeachAndPlay(robot);}
		//case TORQUECONTROL:{  return new TorqueControl(robot);}
		//case HAPTICS:{  return new Haptics(robot);}
        default:{   
