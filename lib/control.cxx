...
void Controller::backdrive_hand(){
        ...
        double finger_joint_step = 1;//exp_vars[MISC_PARMS][0];
        double tact_stop = 1;//exp_vars[MISC_PARMS][1];
        double tact_push = 1;//exp_vars[MISC_PARMS][2];
        double fingertip_torque_stop = 1;//exp_vars[MISC_PARMS][3];
        double fingertip_torque_push = 1;//exp_vars[MISC_PARMS][4];
        double fingertip_torque_pull = 1;//exp_vars[MISC_PARMS][5];
        //double temp = 1;//exp_vars[MISC_PARMS][6];
        /*std::cout << "parameters: ";
        ...
        //std::cout << "exp_vars[TACT_BASE_VAL]s: ";
        //std::cout     << exp_vars[TACT_BASE_VAL][0] << ", "
        //                      << exp_vars[TACT_BASE_VAL][1] << ", "
        //                      << exp_vars[TACT_BASE_VAL][2] << std::endl;
        ...
        while(!backdrivesemastop){
                ...
                for(int i = 0; i < num_fingers; i++){
                        //F > zero_thresh
                        if(check_tactile_contact(hand, i, exp_vars[TACT_BASE_VAL][i]*tact_stop)||
